...
use crate::source_file::liquibase_util::{
    add_column_with_computed_value,
    add_column_with_number_value,
    add_column_with_string_value,
    end_change_set_tag,
    end_database_change_log_tag,
    start_change_set_tag,
    start_database_change_log_tag,
    write_xml_declaration
};

pub fn generate_menu_group_liquibase(menu_group: &MenuGroup, modify_info: ModifyInfo) -> Result<String> {
